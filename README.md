...
- Array & ArrayList & LinkedList [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Array%20vs%20ArrayList%20vs%20LinkedList.md)
- 스택(Stack) & 큐(Queue) [개념](https://engineerinsight.tistory.com/315) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Stack%20and%20Queue.md)
- 힙(Heap) [개념](https://engineerinsight.tistory.com/320) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Binary%20Heap.md)
- 트리(Tree) [개념](https://engineerinsight.tistory.com/316) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Tree.md)
- 이진 트리(Binary Tree) [개념](https://engineerinsight.tistory.com/317)
- 이진탐색트리(Binary Search Tree) [개념](https://engineerinsight.tistory.com/321) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Binary%20Search%20Tree.md)
- AVL 트리 [개념](https://engineerinsight.tistory.com/329)
- Red-Black 트리
- Hash [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Hash.md)
...
- 트라이(Trie) [개념](https://engineerinsight.tistory.com/335) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Trie.md)
- B-Tree [개념](https://engineerinsight.tistory.com/330) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/B-Tree.md)
  - [DB 인덱스에서 B-Tree 계열을 사용하는 이유](https://engineerinsight.tistory.com/331)
- B+Tree [개념](https://engineerinsight.tistory.com/336) [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/B%2BTree.md)
- Graph [이리내의 정리](https://github.com/seoul-developer/CS/blob/irene/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/Graph.md)
